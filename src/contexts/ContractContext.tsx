...
const defaultSettings: ContractSettings = {
  tokenAddress: "0x YOUR_MAINNET_TOKEN_ADDRESS", // CFI Token on BSC Mainnet - UPDATE THIS
  tokenABI: TOKEN_ABI,
  crowdfundingAddress: "0x YOUR_MAINNET_CROWDFUNDING_ADDRESS", // CrowdFunding contract on BSC Mainnet - UPDATE THIS
