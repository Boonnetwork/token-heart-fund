...
const defaultSettings: ContractSettings = {
  tokenAddress: "0x YOUR_TESTNET_TOKEN_ADDRESS", // CFI Token on BSC Testnet - UPDATE THIS
  tokenABI: TOKEN_ABI,
  crowdfundingAddress: "0x YOUR_TESTNET_CROWDFUNDING_ADDRESS", // CrowdFunding contract on BSC Testnet - UPDATE THIS
